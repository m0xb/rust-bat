...
class TestLiteralFunctions(unittest.TestCase):
    def test_integer(self):
        ...
        self.assertEqual((12345, 5), arg_list_parser.integer('12345', 0))
        self.assertEqual((234, 4), arg_list_parser.integer('1234', 1))
        self.assertEqual((1234, 4), arg_list_parser.integer('1234.5678', 0))
        self.assertEqual((123, 3), arg_list_parser.integer('123a345.789', 0))
    ...
    def test_floating_point(self):
        ...
        self.assertEqual((1., 2), arg_list_parser.floating_point('1.', 0))
        self.assertEqual((1., 2), arg_list_parser.floating_point('1..0', 0))
        self.assertEqual((1.1, 3), arg_list_parser.floating_point('1.1', 0))
        self.assertEqual((1234.0, 6), arg_list_parser.floating_point('1234.0', 0))
        self.assertEqual((1234.56789, 10), arg_list_parser.floating_point('1234.56789', 0))
        self.assertEqual((234.56789, 10), arg_list_parser.floating_point('1234.56789', 1))
